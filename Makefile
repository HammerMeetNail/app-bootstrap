.PHONY: local down build up logs test lint clean assets e2e e2e-headed e2e-debug test-backend test-frontend release init github-bootstrap
...
# Initialize the template into a real project
init:
	@bash ./scripts/template-init.sh

# Bootstrap GitHub repo + Actions vars/secrets
github-bootstrap:
