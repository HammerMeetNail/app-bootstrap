...
func TestLoad_Defaults(t *testing.T) {
	...
	if cfg.Database.User != "__TEMPLATE_PROJECT_SLUG__" {
		t.Errorf("expected Database.User to be __TEMPLATE_PROJECT_SLUG__, got %s", cfg.Database.User)
	}
	if cfg.Database.Password != "__TEMPLATE_PROJECT_SLUG__" {
		t.Errorf("expected Database.Password to be __TEMPLATE_PROJECT_SLUG__, got %s", cfg.Database.Password)
	}
	if cfg.Database.DBName != "__TEMPLATE_PROJECT_SLUG__" {
		t.Errorf("expected Database.DBName to be __TEMPLATE_PROJECT_SLUG__, got %s", cfg.Database.DBName)
	}
